  ...
  return (
    <div className="form-container">
      <form onSubmit={handleSubmit}>
        ...
        <br />
        <label>
          Latar Belakanag Pendidikan: <span className="required">*</span> <br />
        ...
        <br />
        <label htmlFor="kelas">
          Kelas Coding yang Dipilih: <span className="required">*</span> <br />
        ...
        <label htmlFor="harapan">
          Harapan Untuk Coding Bootcamp: <br />
          <textarea
            name="harapan"
            id="harapan"
            placeholder="Write your hope"
          ></textarea>
        </label>{" "}
        <br />
